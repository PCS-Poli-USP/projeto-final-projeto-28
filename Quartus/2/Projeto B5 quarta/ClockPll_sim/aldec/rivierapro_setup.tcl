...
# ACDS 20.1 720 win32 2023.05.31.14:54:17
# ----------------------------------------
...
# ----------------------------------------
# If ClockPll is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ClockPll.vho"
}
