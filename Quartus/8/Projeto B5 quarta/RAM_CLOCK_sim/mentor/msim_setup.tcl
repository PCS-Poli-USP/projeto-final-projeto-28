...
# ----------------------------------------
# If RAM_CLOCK is one of several IP cores in your
...
# ----------------------------------------
# ACDS 20.1 720 win32 2023.06.20.07:57:14
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/RAM_CLOCK.vho"
}
